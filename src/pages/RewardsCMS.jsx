  ...
  return (
    <div className="p-8">
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          <h1 className="text-2xl font-bold text-textMain mb-1">Global Reward Campaigns CMS</h1>
          <p className="text-textMuted text-sm">Create Swiggy & Cred style global cashback offers, scratch rewards, and targeting rules.</p>
        </div>
        <div className={clsx(
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {/* Right Column - Table of all campaigns */}
